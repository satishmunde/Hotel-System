    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ForeignKey(default=-1, on_delete=django.db.models.deletion.SET_DEFAULT, to='employees.department')),
                ('employee', models.ForeignKey(default=-1, on_delete=django.db.models.deletion.SET_DEFAULT, to='employees.employee')),
                ('position', models.ForeignKey(default=-1, on_delete=django.db.models.deletion.SET_DEFAULT, to='employees.position')),
            ],
        ),
    ]
